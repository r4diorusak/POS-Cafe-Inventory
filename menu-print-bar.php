 ...
 echo date("d/m/Y"); ?></span>
  ...
  <table width="275px" border=0>
   ...
   echo   "
    ...
    $list2= mysql_query("SELECT menu,sum(jumlah) as qty,b.penyedia FROM `orders_temp` a, menu b WHERE a.id_menu=b.id_menu and b.penyedia='Bar' and meja='$no_meja' and status='0' group by menu");	
    $no2 = 1;
	...
	$upd_sql=mysql_query("UPDATE `orders_temp` SET `status`='1' WHERE meja='$no_meja' and status='0' and penyedia='Bar'");	
   ?>
