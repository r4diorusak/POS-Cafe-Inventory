...
<br>-----------------------------------</p>
  ...
  <?php 
  $list= mysql_query("SELECT a.invoice,sum(jumlah) as qty,total_bayar,(total_bayar*diskon) ds,(total_bayar*pajak) pj, (total_bayar*jasa) js from invoice a,invoice_detail b,menu c where a.tgl_order=CURDATE() and a.invoice=b.invoice and b.id_menu=c.id_menu GROUP by b.invoice order by a.invoice DESC");
  ...
  <table width="275px" border=0>
   ...
   echo   
    ...
    $list2= mysql_query("SELECT b.id_menu,c.menu,sum(jumlah) as jmlh from invoice a,invoice_detail b,menu c where a.tgl_order=CURDATE() and a.invoice=b.invoice and b.id_menu=c.id_menu GROUP by b.id_menu order by c.kategori ASC");
    $no2 = 1;
