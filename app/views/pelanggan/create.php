...
<head>
    ...
    <title>Tambah Pelanggan - POS Cafe Inventory</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1><i class="fa fa-user-plus"></i> Tambah Pelanggan Baru</h1>
        </div>

        <!-- Content -->
        <div class="content-box">
            <form method="POST" action="../../../index.php?controller=pelanggan&action=store">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-submit"><i class="fa fa-save"></i> Simpan</button>
