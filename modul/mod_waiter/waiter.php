...
$ketemu=mysql_num_rows($cari);
 ...
 if ($_SESSION['tot_bayar']==""){ echo "<div class='alert alert-danger alert-dismissible'><b><i class='fa fa-warning'></i> Pilih Menu Terlebih Dahulu !</b></div>";
   ...
   //
	...
	echo "<script>location='media.php?module=home&aksi=module=p_menu</script>";	
...
if($opr=="invoice"){
	...
	echo "<script>location='media.php?module=home&aksi=module=p_menu&id=$invoice'</script>";	
          ...
          <div class="box box-primary">
			...
			//$res = mysql_query("SELECT * FROM `menu`");
			  while($row=mysql_fetch_array($res)){ 		
				 ...
				 $link='<a class="btn icon-btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Tambah Menu" href="media.php?module=p_menu&meja='.$row['no_meja'].'"><i class="fa  fa-plus"></i></a>';
				 
				 if($row['status']==null){   
					$status='';
				 }elseif($row['status']==0){   
					$status='<a class="btn icon-btn btn-default" data-toggle="tooltip" data-placement="bottom" title="Dalam Proses" ><i class="fa fa-refresh fa-spin"></i></a>';
				 }elseif($row['status']==1){   
					$status='<a class="btn icon-btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Berhasil" ><i class="fa fa-check"></i></a>';	
				 }		
				...
				echo '
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						  <div class="info-box2">
						  <a href="media.php?module=p_menu&meja='.$row['no_meja'].'">
		 ...
		 <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header ui-sortable-handle" style="cursor: move;">
              ...
              <h3 class="box-title">Ruang Meeting</h3>
...
<div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header ui-sortable-handle" style="cursor: move;">
              ...
              <h3 class="box-title">Bawa Pulang</h3>
			...
			<?php
			$no = 1;
			$res = mysql_query("SELECT * FROM meja LEFT JOIN orders_temp ON meja.id_meja = orders_temp.meja WHERE id_meja > 0 and lokasi='B.Pulang' group by meja.id_meja order by meja.id_meja asc");
