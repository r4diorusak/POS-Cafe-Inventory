<form method="post">
	<div class='box-body'>
    <table id="dataTables_paket" class="table-bordered" style="width:100%;">
		...
		<tbody>
			<?php
			$no = 1;
			$res = mysql_query("SELECT * FROM `menu` a,kategori b where a.kategori=b.id_kategori and nama_kategori='softdrink' ORDER by a.menu DESC");
			//$res = mysql_query("SELECT * FROM `menu`");
			  while($row=mysql_fetch_array($res)){
				...
				<tr>
					...
					<td width=80px align=center><a name="btn_edit" class="btn icon-btn btn-info" href="media.php?module=bw_pulang&meja='.$_SESSION['meja'].'&opr=upd&rs_id='.$row['id_menu'].'">
