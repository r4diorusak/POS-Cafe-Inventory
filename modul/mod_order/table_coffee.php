 <form method="POST" action="modul/mod_kasir/kasir.php">
	<div class='box-body'>
    <table id="dataTables_coffee" class="table-bordered" style="width:100%;">
		...
		<tbody>
			<?php
			$no = 1;
			$res = mysql_query("SELECT * FROM `menu` a,kategori b where a.kategori=b.id_kategori and nama_kategori='Coffee' ORDER by a.menu DESC");
